...
<div class="dropdown">
	...
	<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
		...
		<li class="disabled">
			<a href="ConnectNetworkVm?vmId=<%=vmId%>&vmName=<%=vmName%>">Connexion à un réseau</a>
		</li>
		 <div class="dropdown-divider"></div>
		<li><button type="button" class="btn"
					data-toggle="modal" data-target="#modalSnapshot">Créer un snapshot</button></li>
		...
		<li><a href="ExportOVA?vmId=<%=vmId%>">Export OVF</a></li>
		 <div class="dropdown-divider"></div>
		<li><a href="SupprimerVm?vmId=<%=vmId%>" onclick="return confirm('Etes-vous sûr de vouloir supprimer <%=vmName%> ?');">Supprimer</a></li>
	</ul>
</div>
